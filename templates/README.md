...
Install [Pandoc](https://github.com/jgm/pandoc/) and use it to convert the markdown documents to a PDF/DOCX file.
```bash
# To DOCX
...
Optionally, to avoid issues/bloat, you may install [Docker](https://docs.docker.com/engine/install/) and run the respective command for PDF/DOCX
```bash
# To DOCX
